...
#define CONFIG_NUMBER_OF_CLOCK 		1
#define CONFIG_NUMBER_THERMO		13
#define CONFIG_LENGTH_OF_ROOT 		50


#define CONFIG_NUMBER_OF_DEVICES	(CONFIG_NUMBER_RELAYS + CONFIG_NUMBER_CONTACTORS + CONFIG_NUMBER_THERMO + CONFIG_NUMBER_OF_CLOCK + 1) 	
