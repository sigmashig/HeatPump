...
#define EEPROM_ADDR_CONFIG_CALENDARSERVICETYPE EEPROM_ADDR_CONFIG+6

#define EEPROM_ADDR_CONFIG_END EEPROM_ADDR_CONFIG_CALENDARSERVICETYPE
...
#define EEPROM_ADDR_TBUS_PIN	(1 + EEPROM_ADDR_SCHED + EEPROM_NUMB_SCHED * EEPROM_LEN_SCHED)
...
#define EEPROM_NUMB_THERM	CONFIG_NUMBER_THERMO


// Relay Pins Settings
// Pin + lhOn
#define EEPROM_ADDR_RELAY	(1+EEPROM_ADDR_THERM + EEPROM_NUMB_THERM * EEPROM_LEN_THERM)
#define EEPROM_NUMB_RELAY	6
#define EEPROM_LEN_RELAY	2

// Contactor Pins Settings
// Pin + lhOn
#define EEPROM_ADDR_CONTACTOR	(1+EEPROM_ADDR_RELAY + EEPROM_NUMB_RELAY * EEPROM_LEN_RELAY)
#define EEPROM_NUMB_CONTACTOR	2
#define EEPROM_LEN_CONTACTOR	2

//Clock Settings
#define EEPROM_ADDR_CLOCK	(1+EEPROM_ADDR_CONTACTOR + EEPROM_NUMB_CONTACTOR * EEPROM_LEN_CONTACTOR)
#define EEPROM_LEN_CLOCK	5
// 0| type of clock: 0=DS1302, 1=DS3231
// 1| timezone (-12...+12)
// 2|  datPin
// 3|  cePin 
// 4|  clkPin
...
// 
#define EEPROM_ADDR_POWERMETER	(1+EEPROM_ADDR_CLOCK + EEPROM_LEN_CLOCK)
#define EEPROM_LEN_POWERMETER	4

// TimeZone Settings MUST BE THE LAST!!!!!
// 
//#define EEPROM_ADDR_TIMEZONE	(1+EEPROM_ADDR_POWERMETER + EEPROM_LEN_POWERMETER)
